...
Welcome to the TasksGenerator Crew project, powered by [crewAI](https://crewai.com). This template is designed to help you set up a multi-agent AI system with ease, leveraging the powerful and flexible framework provided by crewAI. Our goal is to enable your agents to collaborate effectively on complex tasks, maximizing their collective intelligence and capabilities.
...
- Modify `src/tasks_generator/config/agents.yaml` to define your agents
- Modify `src/tasks_generator/config/tasks.yaml` to define your tasks
- Modify `src/tasks_generator/crew.py` to add your own logic, tools and specific args
- Modify `src/tasks_generator/main.py` to add custom inputs for your agents and tasks
...
This command initializes the tasks-generator Crew, assembling the agents and assigning them tasks as defined in your configuration.
